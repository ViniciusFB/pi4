                ...
                <div class="col-md-6" data-animate="fadeInDown">
                    <ul class="menu">
                        ...
                        <li class="dropdown yamm-fw">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">Usuário logado: ${usuario}<b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li>
                                    <div style="background-color: #555555" class="yamm-content">
                                        <ul>
                                            <li><a href="category.html">Minha conta</a>
                                            </li>
                                            <li><a href="category.html">Logout</a>
                                            </li>
                                            <li><a href="category.html">Minha conta</a>
                                            </li>
                                            <li><a href="category.html">Logout</a>
